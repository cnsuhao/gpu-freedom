...
if (getPHPVersion()>=50500) include_once('../utils/mydql2i/mysql2i.class.php');
 ...
 $query="select count(*), concat(month(create_dt),'-',year(create_dt)) as my from tbjobresult group by my order by create_dt asc;";
...
$g = new graph();
$g->title( 'Results per Month', '{font-size:18px; color: #d01f3c}' );
