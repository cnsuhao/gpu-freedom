...
*/
 ...
 sql2xml("select r.id, r.jobresultid, r.jobid, r.jobqueueid, r.jobresult, r.workunitresult, r.iserroneous, r.errorid, r.errorarg,
                 r.errormsg, r.nodename, r.nodeid, q.create_dt, q.transmission_dt, q.reception_dt, d.job,
				 d.nodename
