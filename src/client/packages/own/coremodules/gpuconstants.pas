...
const
  ...
  STK_ARG_SPECIAL_CALL_PLUGIN   = 60;
  STK_ARG_SPECIAL_CALL_FRONTEND = 70;
  STK_ARG_SPECIAL_CALL_NODE     = 80;
  STK_ARG_SPECIAL_CALL_USER     = 90;
  STK_ARG_SPECIAL_CALL_THREAD   = 100;
  STK_ARG_SPECIAL_CALL_RESULT   = 110;
  STK_ARG_SPECIAL_CALL_CORE     = 120;
