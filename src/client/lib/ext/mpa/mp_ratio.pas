...
procedure mpr_init_size(var a: mp_rat; nsize, dsize: word);
...
procedure mpr_toradix_n(const a: mp_rat; str: pchar8; radix, maxlen: word);
...
procedure s_mpr_tofloat_n(const a: mp_rat; var str: pchar8; radix, prec, maxlen: word);
