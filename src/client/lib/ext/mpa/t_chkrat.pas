...
{$ifdef MP_32BIT}
  TV: array[-2..2] of longint = ($460006,$4A0007,$180003,$3C0006,$380005);  {4 byte mp_digits}
{$else}
  TV: array[-2..2] of longint = ($320006,$340007,$120003,$2A0006,$280005);  {2 byte mp_digits}
{$endif}
var
  i,f: integer;
  A1, AF: longint;
