! If you use this calculator or the FORTRAN code, please cite the following publication:
! "Habitable Zones Around Main-Sequence Stars: New Estimates" by Kopparapu et al.(2013), Astrophysical Journal, 765, 131 
! Source code from http://depts.washington.edu/naivpl/sites/default/files/HZ_Calc.html
