...
wget -O frequency.html --no-check-certificate -U "Mozilla/5.0 (Windows NT 6.1; rv:2.0b7pre) Gecko/20100921 Firefox/4.0b7pre" http://www.swissgrid.ch/swissgrid/de/applicationFrequencyTimeAjax
